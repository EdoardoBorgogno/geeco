...
$(document).ready(function () {
            ...
            if (password == confirmPassword)
            {
                ...
                if (validateEmail(email))
                {
                    ...
                    if (validateBirthDate(birthDate))
                    {
                        ...
                        var data = jQuery.param({ customerFirstName: firstName, 
                                                  customerLastName: lastName, 
                                                  customerPhone: phone, 
                                                  customerDateBirth: birthDate, 
                                                  customerEmail: email, 
                    ...
                    {
                        $('#errorMessageText').text('You must be at least 14 years old to sign up.');
                        $('#errorMessageText').css('opacity', '1');
                    }
                }
                else
    ...
    //function to check birth date is higher than 14 years old
    function validateBirthDate(birthDate)
    {
        ...
        if (age < 14)
        {
            $('#errorMessageText').text('You must be at least 14 years old');
            $('#errorMessageText').css('opacity', '1');
            return false;
        }
        else
